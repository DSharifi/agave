...
impl TaskInner {
    ...
    pub fn transaction(&self) -> &RuntimeTransaction<ResolvedTransactionView<Bytes>> {
        &self.transaction
    }
    ...
    pub fn into_transaction(self: Task) -> RuntimeTransaction<ResolvedTransactionView<Bytes>> {
...
mod tests {
    ...
    fn simplest_transaction() -> RuntimeTransaction<ResolvedTransactionView<Bytes>> {
